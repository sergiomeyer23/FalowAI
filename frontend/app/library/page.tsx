...
const modules: Array<{ key: SkillKey; title: string; description: string; level: string; icon: typeof BookIcon; color: string; href: string }> = [
  ...
  { key: 'reading', title: 'Reading', description: 'Train inference, tone, argument structure and implicit meaning.', level: 'B2+ focus', icon: BookIcon, color: 'rgba(53,201,139,.13)', href: '/practice' },
  { key: 'listening', title: 'Listening', description: 'Work with natural pace, detail, implication and real registers.', level: 'B1+ focus', icon: VolumeIcon, color: 'rgba(242,184,75,.13)', href: '/practice' },
  { key: 'writing', title: 'Writing', description: 'Turn clear sentences into coherent, precise professional texts.', level: 'B2 focus', icon: ChartIcon, color: 'rgba(232,121,168,.13)', href: '/practice' },
